...
function articleMaker(obj) {
  let firstDiv = document.querySelector(".articles");
  ...
  for (let i = 0; i < 3; i++) {
    ...
    if (i === 0) news.textContent = obj.firstParagraph;
    else if (i === 1) news.textContent = obj.secondParagraph;
    else news.textContent = obj.thirdParagraph;
...
data.forEach((news) => articleMaker(news));
